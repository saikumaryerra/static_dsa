...
| `docs/deployment.md` | production deploy: the deployment URL per host (§2), sub-path hosting, Cloudflare Pages + GitHub Actions, Node pin, DoD gate |
